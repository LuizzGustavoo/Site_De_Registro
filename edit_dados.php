...
<body>
    <div class="box">
        ...
        <br>
        <a href="formulario_aluno.php">Relatorio | Comunidade </a>
        <a href="formulario_servidores.php">Relatorio | Alunos</a>
        <a href="formulario_comunidade.php">Edição de dados | Comunidade</a>
    </div>
</body>
</html>
